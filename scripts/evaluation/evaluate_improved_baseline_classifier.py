...
from scripts.improved_baseline_classifier import ImprovedBaselineClassifier
from scripts.evaluation_utils import plot_confusion_matrix, synchronize_device


def evaluate_improved_baseline():
    # --- Config ---
    checkpoint_path = 'best_improved_baseline_classifier.pth'
    dataset_path = './dataset'
    batch_size = 32
    num_classes = 7
    quality = 3  # Ensure this matches the trained model
    dropout_rate = 0.5 # Ensure this matches the trained model

    # Dynamically get class names from the test directory
    ...
    # --- Load Classifier ---
    print("Loading Improved Baseline Classifier...")
    ...
    plot_confusion_matrix(cm, class_names, save_path='improved_baseline_confusion_matrix.png')
