...
def evaluate_baseline():
    ...
    model.load_state_dict(torch.load(baseline_classifier_checkpoint_path, map_location=device))
    model.to(device)
    model.eval()
    ...
    plot_confusion_matrix(cm, class_names, save_path='baseline_confusion_matrix.png')
